...
export default function BiDonutChart({
  title,
  subtitle,
  items,
  emptyText,
  ...
  return (
    <BiChartShell
      ...
      minHeight={240}
    >
      <div className="flex h-full min-h-[240px] flex-col items-center gap-4 sm:flex-row sm:justify-between">
        ...
        <ul className="w-full min-w-0 space-y-2.5 sm:max-w-[200px]">
          {items.map((item) => {
            const percent =
            ...
            return (
              ...
              >
                <span className="flex min-w-0 items-center gap-2">
                  ...
                  />
                  <span className="truncate font-medium capitalize text-[var(--text-secondary)]">
                    {item.label}
                  </span>
                </span>
